...
# changes:
# add facets parser:
# https://github.com/morrislab/phylowgs/pull/104/files#diff-9836cf06f683e922fc97209998bf25c4

# changes to TITAN parser
# https://github.com/morrislab/phylowgs/pull/113/files
  ...
  def parse(self):
    ...
    with open(self._titan_filename) as titanf:
      ...
      for record in reader:
        ...
        # SS this has been renamed:
        # https://github.com/gavinha/TitanCNA/issues/52
